...
int main(void) {
    ...
    NSDateFormatter *dfEn = [[NSDateFormatter alloc] init];
    [dfEn setLocale:[NSLocale localeWithLocaleIdentifier:@"en_US"]];
    [dfEn setDateStyle:NSDateFormatterShortStyle];
    p("df style short", [dfEn stringFromDate:fmtBase]);
    [dfEn setDateStyle:NSDateFormatterLongStyle];
    p("df style long", [dfEn stringFromDate:fmtBase]);
    [dfEn setDateStyle:NSDateFormatterNoStyle];
    [dfEn setTimeStyle:NSDateFormatterShortStyle];
    p("df time short", [dfEn stringFromDate:fmtBase]);
    [dfEn setDateStyle:NSDateFormatterMediumStyle];
    [dfEn setTimeStyle:NSDateFormatterShortStyle];
    p("df styles medium short", [dfEn stringFromDate:fmtBase]);
    NSDateFormatter *dfPrec = [[NSDateFormatter alloc] init];
    [dfPrec setLocale:[NSLocale localeWithLocaleIdentifier:@"en_US"]];
    [dfPrec setDateStyle:NSDateFormatterLongStyle];
    [dfPrec setDateFormat:@"yyyy-MM-dd"];
    p("df styles after format", [NSString stringWithFormat:@"d=%lu t=%lu fmt=%@ out=%@",
                                 (unsigned long)dfPrec.dateStyle, (unsigned long)dfPrec.timeStyle,
                                 dfPrec.dateFormat, [dfPrec stringFromDate:fmtBase]]);
    p("df template class", [NSDateFormatter dateFormatFromTemplate:@"yyyyMMMd" options:0
                                                             locale:[NSLocale localeWithLocaleIdentifier:@"en_US"]]);
    NSDateFormatter *dfTpl = [[NSDateFormatter alloc] init];
    [dfTpl setLocale:[NSLocale localeWithLocaleIdentifier:@"en_US"]];
    [dfTpl setLocalizedDateFormatFromTemplate:@"yyyyMMMd"];
    p("df template set out", [dfTpl stringFromDate:fmtBase]);
    p("df template set fmt", dfTpl.dateFormat);
    p("df template read styles", [NSString stringWithFormat:@"%lu/%lu",
                                  (unsigned long)dfTpl.dateStyle, (unsigned long)dfTpl.timeStyle]);
    [dfTpl setLocale:[NSLocale localeWithLocaleIdentifier:@"de_DE"]];
    [dfTpl setLocalizedDateFormatFromTemplate:@"yMMMMd"];
    p("df template de set", [dfTpl stringFromDate:fmtBase]);
    NSDateFormatter *dfRel = [[NSDateFormatter alloc] init];
    [dfRel setLocale:[NSLocale localeWithLocaleIdentifier:@"en_US"]];
    p("df relative default", [NSString stringWithFormat:@"%d", dfRel.doesRelativeDateFormatting]);
    [dfRel setDoesRelativeDateFormatting:YES];
    p("df relative set", [NSString stringWithFormat:@"%d", dfRel.doesRelativeDateFormatting]);
    [dfRel setDateStyle:NSDateFormatterShortStyle];
    p("df relative fmt short", [dfRel stringFromDate:fmtBase]);
    NSDateFormatter *dfGs = [[NSDateFormatter alloc] init];
    p("df gregorian default nil", [NSString stringWithFormat:@"%d", dfGs.gregorianStartDate == nil]);
    [dfGs setGregorianStartDate:[NSDate dateWithTimeIntervalSinceReferenceDate:0]];
    p("df gregorian set getter", [NSString stringWithFormat:@"%.0f", dfGs.gregorianStartDate.timeIntervalSinceReferenceDate]);
    NSDateFormatter *dfTwd = [[NSDateFormatter alloc] init];
    [dfTwd setLocale:[NSLocale localeWithLocaleIdentifier:@"en_US"]];
    [dfTwd setTimeZone:[NSTimeZone timeZoneForSecondsFromGMT:0]];
    [dfTwd setCalendar:[NSCalendar calendarWithIdentifier:NSCalendarIdentifierGregorian]];
    [dfTwd setDateFormat:@"yy"];
    NSDate *dfTwd90 = [NSDate dateWithTimeIntervalSince1970:631152000.0];
    NSDate *dfTwd70 = [NSDate dateWithTimeIntervalSince1970:0.0];
    p("df formatter class fb", [NSString stringWithFormat:@"%lu", (unsigned long)[NSDateFormatter defaultFormatterBehavior]]);
    p("df formatter inst fb", [NSString stringWithFormat:@"%lu", (unsigned long)[dfTwd formatterBehavior]]);
    p("df twodigit default nil", [NSString stringWithFormat:@"%d", dfTwd.twoDigitStartDate == nil]);
    p("df twodigit default getter", [NSString stringWithFormat:@"%.0f", dfTwd.twoDigitStartDate.timeIntervalSince1970]);
    p("df twodigit parse 13@default", [NSString stringWithFormat:@"%.0f", [dfTwd dateFromString:@"13"].timeIntervalSince1970]);
    [dfTwd setFormatterBehavior:NSDateFormatterBehavior10_4];
    p("df formatter inst fb set1040", [NSString stringWithFormat:@"%lu", (unsigned long)[dfTwd formatterBehavior]]);
    [dfTwd setFormatterBehavior:NSDateFormatterBehaviorDefault];
    p("df formatter inst fb setdflt", [NSString stringWithFormat:@"%lu", (unsigned long)[dfTwd formatterBehavior]]);
    [dfTwd setTwoDigitStartDate:dfTwd90];
    p("df twodigit set1990 getter", [NSString stringWithFormat:@"%.0f", dfTwd.twoDigitStartDate.timeIntervalSince1970]);
    p("df twodigit parse 30@1990", [NSString stringWithFormat:@"%.0f", [dfTwd dateFromString:@"30"].timeIntervalSince1970]);
    p("df twodigit parse 60@1990", [NSString stringWithFormat:@"%.0f", [dfTwd dateFromString:@"60"].timeIntervalSince1970]);
    p("df twodigit parse 89@1990", [NSString stringWithFormat:@"%.0f", [dfTwd dateFromString:@"89"].timeIntervalSince1970]);
    p("df twodigit parse 90@1990", [NSString stringWithFormat:@"%.0f", [dfTwd dateFromString:@"90"].timeIntervalSince1970]);
    [dfTwd setTwoDigitStartDate:dfTwd70];
    p("df twodigit parse 68@1970", [NSString stringWithFormat:@"%.0f", [dfTwd dateFromString:@"68"].timeIntervalSince1970]);
    p("df twodigit parse 70@1970", [NSString stringWithFormat:@"%.0f", [dfTwd dateFromString:@"70"].timeIntervalSince1970]);
    [dfTwd setTwoDigitStartDate:nil];
    p("df twodigit reset nil getter", [NSString stringWithFormat:@"%.0f", dfTwd.twoDigitStartDate.timeIntervalSince1970]);
    NSDateFormatter *dfSym = [[NSDateFormatter alloc] init];
    [dfSym setLocale:[NSLocale localeWithLocaleIdentifier:@"en_US"]];
    p("df era en", joinWith([dfSym eraSymbols], @"|"));
    p("df longera en", joinWith([dfSym longEraSymbols], @"|"));
    p("df month en", joinWith([dfSym monthSymbols], @"|"));
    p("df shortmonth en", joinWith([dfSym shortMonthSymbols], @"|"));
    p("df vshortmonth en", joinWith([dfSym veryShortMonthSymbols], @"|"));
    p("df weekday en", joinWith([dfSym weekdaySymbols], @"|"));
    p("df shortweekday en", joinWith([dfSym shortWeekdaySymbols], @"|"));
    p("df vshortweekday en", joinWith([dfSym veryShortWeekdaySymbols], @"|"));
    p("df standmonth en", joinWith([dfSym standaloneMonthSymbols], @"|"));
    p("df shortstandmonth en", joinWith([dfSym shortStandaloneMonthSymbols], @"|"));
    p("df vshortstandmonth en", joinWith([dfSym veryShortStandaloneMonthSymbols], @"|"));
    p("df standweekday en", joinWith([dfSym standaloneWeekdaySymbols], @"|"));
    p("df shortstandweekday en", joinWith([dfSym shortStandaloneWeekdaySymbols], @"|"));
    p("df vshortstandweekday en", joinWith([dfSym veryShortStandaloneWeekdaySymbols], @"|"));
    p("df quarter en", joinWith([dfSym quarterSymbols], @"|"));
    p("df shortquarter en", joinWith([dfSym shortQuarterSymbols], @"|"));
    p("df standquarter en", joinWith([dfSym standaloneQuarterSymbols], @"|"));
    p("df shortstandquarter en", joinWith([dfSym shortStandaloneQuarterSymbols], @"|"));
    p("df ampm en", [NSString stringWithFormat:@"%@/%@", [dfSym AMSymbol], [dfSym PMSymbol]]);
    [dfSym setMonthSymbols:@[@"X1", @"X2", @"X3"]];
    p("df setmonth roundtrip", joinWith([dfSym monthSymbols], @"|"));
    [dfSym setAMSymbol:@"Morning"];
    p("df setampm roundtrip", [dfSym AMSymbol]);
    NSDateFormatter *dfDe = [[NSDateFormatter alloc] init];
    [dfDe setLocale:[NSLocale localeWithLocaleIdentifier:@"de_DE"]];
    p("df month de", joinWith([dfDe monthSymbols], @"|"));
    p("df shortmonth de", joinWith([dfDe shortMonthSymbols], @"|"));
    p("df weekday de", joinWith([dfDe weekdaySymbols], @"|"));
    p("df era de", joinWith([dfDe eraSymbols], @"|"));
    p("df quarter de", joinWith([dfDe quarterSymbols], @"|"));
    [dfDe setDateFormat:@"dd.MM.yyyy"];
    p("df de format", [dfDe stringFromDate:fmtBase]);
    [dfDe setDateStyle:NSDateFormatterFullStyle];
    p("df de full", [dfDe stringFromDate:fmtBase]);
    NSDateFormatter *dfFr = [[NSDateFormatter alloc] init];
    [dfFr setLocale:[NSLocale localeWithLocaleIdentifier:@"fr_FR"]];
    [dfFr setDateStyle:NSDateFormatterLongStyle];
    p("df fr long", [dfFr stringFromDate:fmtBase]);
    p("df localized medshort", [NSDateFormatter localizedStringFromDate:fmtBase dateStyle:NSDateFormatterMediumStyle timeStyle:NSDateFormatterShortStyle]);
    p("df localized full long", [NSDateFormatter localizedStringFromDate:fmtBase dateStyle:NSDateFormatterFullStyle timeStyle:NSDateFormatterLongStyle]);
    p("df localized short both", [NSDateFormatter localizedStringFromDate:fmtBase dateStyle:NSDateFormatterShortStyle timeStyle:NSDateFormatterShortStyle]);
    p("df localized short date", [NSDateFormatter localizedStringFromDate:fmtBase dateStyle:NSDateFormatterShortStyle timeStyle:NSDateFormatterNoStyle]);
    p("df localized med time", [NSDateFormatter localizedStringFromDate:fmtBase dateStyle:NSDateFormatterNoStyle timeStyle:NSDateFormatterMediumStyle]);
    p("df localized full time", [NSDateFormatter localizedStringFromDate:fmtBase dateStyle:NSDateFormatterNoStyle timeStyle:NSDateFormatterFullStyle]);
    p("df localized none", [NSDateFormatter localizedStringFromDate:fmtBase dateStyle:NSDateFormatterNoStyle timeStyle:NSDateFormatterNoStyle]);
    NSDateFormatter *dfZ = [[NSDateFormatter alloc] init];
    [dfZ setLocale:[NSLocale localeWithLocaleIdentifier:@"en_US"]];
    [dfZ setDateFormat:@"yyyy-MM-dd HH:mm:ss Z"];
    [dfZ setTimeZone:[NSTimeZone timeZoneWithName:@"Asia/Tokyo"]];
    p("df z tokyo", [dfZ stringFromDate:fmtBase]);
    p("df parse offset plus0100", [NSString stringWithFormat:@"%.0f",
                                   [dfZ dateFromString:@"2009-02-13 23:31:30 +0100"].timeIntervalSince1970]);
    NSDateFormatter *dfLit = [[NSDateFormatter alloc] init];
    [dfLit setLocale:[NSLocale localeWithLocaleIdentifier:@"en_US"]];
    [dfLit setDateFormat:@"yyyy.MM.dd 'at' HH:mm"];
    p("df literal quoted", [dfLit stringFromDate:fmtBase]);
    [dfLit setDateFormat:@"EEEE, MMMM d, yyyy"];
    p("df weekdayname long", [dfLit stringFromDate:fmtBase]);
    NSDateFormatter *dfYy = [[NSDateFormatter alloc] init];
    [dfYy setLocale:[NSLocale localeWithLocaleIdentifier:@"en_US"]];
    [dfYy setDateFormat:@"yy-MM-dd"];
